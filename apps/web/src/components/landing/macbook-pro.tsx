...
const WIDTH = 650
const HEIGHT = 400
const SCREEN = { x: 74.52, y: 21.32, width: 501.22, height: 323.85 }
...
export function MacbookPro({ children, className }: MacbookProProps) {
  return (
    <div className={cn('relative w-full', className)} style={{ aspectRatio: `${WIDTH} / ${HEIGHT}` }}>
      ...
      >
        ...
        />
        <rect fill="#0a0a0a" x={SCREEN.x} y={SCREEN.y} width={SCREEN.width} height={SCREEN.height} rx="5" ry="5" />
        ...
        <polygon className="fill-neutral-400" points="600.06 385.39 567.29 385.39 565.84 383.95 601.82 383.95 600.06 385.39" />
        <polygon fill="#292929" points="598.73 386.82 568.64 386.82 567.32 385.39 600.35 385.39 598.73 386.82" />
        <polygon className="fill-neutral-400" points="82.64 385.39 49.87 385.39 48.43 383.95 84.41 383.95 82.64 385.39" />
      ...
      <div
        className="absolute overflow-hidden rounded-[0.8%] bg-[#0a0a0a]"
        style={{
